...
public class FindPath implements Graph
{
	...
	public static void main(String[] args)
	{
		...
		String starting_city, ending_city, userAttract = null;
		
		System.out.println("Enter your starting city: ");
		starting_city = input.nextLine(); starting_city = starting_city.toLowerCase();
		
		System.out.println("Enter your ending city: ");
		ending_city = input.nextLine(); ending_city = ending_city.toLowerCase();
		
		while(userAttract != " ")
		{
			System.out.println("Enter an attraction. Type 'exit' to stop: ");
			userAttract = input.nextLine(); userAttract = userAttract.toLowerCase();
			if(userAttract.equals("exit"))
			{
				break;
			}
			attractions.add(userAttract);
		}
		List<HashMap<Vertex, String>> finalList = route(starting_city, ending_city, attractions);
